...
It is easiest to start by considering the case of a single nucleus, chosen to be Nucleus 1, moving in the positive $x^1$ direction. \textcolor{red}{First done in \cite{}, also done in \cite{} (good reference)}. The Yang-Mills equations are solved in the light-cone gauge, where $A^+=0$, an axial gauge condition. \textcolor{blue}{(\cite{Kovner:1995ja}: "one has direct access to the gluon distribution functions of the parton model")}
...
\begin{figure}\centering
	\includetikz{space_partition}
	\caption{Partition of spacetime into light-cone quadrants. The quadrants where the Yang-Mills equations will be solved are identified as quadrants 1, 2 and 3. Adapted from \cite{Kovner:1995ja}.}
\label{fig:space_partition}\end{figure}

\begin{figure}\centering
	\includetikz{space_partition_light_cones}
	\caption{}
\end{figure}
