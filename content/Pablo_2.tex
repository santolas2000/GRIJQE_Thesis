...
\subsection{Partition of the nucleus's parton content}
...
The \gls{MV} model's functional probability distribution $W_{MV}$ and corresponding charge density 2-point correlator are physically motivated for the case of large nuclei: \cite{Gelis_habilitation}
\begin{itemize}
...
In this work, the non-evolved \gls{MV} model will be used. The application of this formalism to the two-nuclei system of a \gls{HIC} will be introduced over the next sections. It was first accomplished in \cite{Kovner:1995ja}.
...
After the collision, the nuclei's approximately static high-$x$ partons, %\textcolor{red}{mentioned in the previous section},
...
Adding the contributions of both color currents, the source term becomes\textcolor{red}{\footnote{\textcolor{red}{Justify why the color-current becomes the source term?}}}:
\begin{equation}
