...
The \gls{MV} model's functional probability distribution $W_{MV}$ and corresponding charge density 2-point correlator are physically motivated for the case of large nuclei: \citep{Gelis_habilitation}
\begin{itemize}
