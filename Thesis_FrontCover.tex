...
\vspace{1.0cm}
{\FontLb Glasma Role in Jet Quenching Effects} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
%{\FontMn Subtitle (optional)} \\
%\vspace{1.9cm}
\vspace{2.6cm}
{\FontMb José Soares Trindade Nunes dos Santos} \\ % <<<<< EDIT NAME
\vspace{2.0cm}
{\FontSn \coverThesis} \\
\vspace{0.3cm}
...
{\FontSn %
\begin{tabular}{ll}
 \coverSupervisors: & Dr. Liliana Apolinário \\ % <<<<< EDIT NAME
                    & Dr. Pablo Guerrero Rodriguez    % <<<<< EDIT NAME
\end{tabular} } \\
\vspace{1.0cm}
