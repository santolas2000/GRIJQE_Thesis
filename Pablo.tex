...
Bringing the final solution to light-cone gauge is necessary, as this is the gauge where the parton distribution operators have the physical interpretation of quantifying the parton populations inside a hadron. \citep{Kovner_1995}\citep[Section 5.1.1]{Lappi_high_energy}\citep[Section 2.4]{Iancu:2000hn} Thus, this gauge is required in order to use our previous insights concerning the low-$x$ gluon populations within protons. Additionally, use of the light-cone gauge allows reducing the problem to two degrees of freedom ($A^2$ and $A^3$). \citep[Section 5.1.1]{Lappi_high_energy}.
