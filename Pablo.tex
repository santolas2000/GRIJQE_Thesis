...
\label{eq:E_B_from_F}
\end{subequations}
with $i,j=2,3$. Defined this way, $E^\eta= E^1$ and $B^\eta = B^1$ everywhere, earning them the name ``longitudinal fields''; on the other hand, $E^i_{\text{Minkowski}} = E^i_{\text{Milne}}$  and $B^i_{\text{Minkowski}} = B^i_{\text{Milne}}$ ($i=2,3$) at midrapidity -- these are the transverse fields.
