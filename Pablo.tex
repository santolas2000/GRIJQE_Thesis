...
A more recent calculation for our case can be found in \cite[Section 2.2]{Blaizot_2004}.

 The Yang-Mills equations are solved in the Lorenz, or covariant, gauge, where $\partial_\mu A^\mu=0$, an axial gauge condition. \textcolor{blue}{(\citep{Kovner_1995}: "one has direct access to the gluon distribution functions of the parton model")}
