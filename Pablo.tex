...
\begin{alignat}{2}
	A^+_2 & = 0 && \\
	A^-_2 & = 0 && \\
	A^i_2 & = \frac{i}{g} U_2(x^+,\mathbf{x}_\perp)&& ^\dagger ~  \partial^i U_2(x^+,\mathbf{x}_\perp), \qquad i = 1,2\\
...
Moving to the scenario where both nuclei are present -- the \gls{HIC} -- 
