...
\begin{subequations}
\begin{gather}
	\alpha(\tau,\mathbf{x}_\perp) = U (\mathbf{x}_\perp) \beta(\tau,\mathbf{x}_\perp) U^\dagger (\mathbf{x}_\perp) \\
	\alpha^i(\tau,\mathbf{x}_\perp) = U (\mathbf{x}_\perp) \left( \beta(\tau,\mathbf{x}_\perp) - \frac{1}{ig} \partial^i \right) U^\dagger (\mathbf{x}_\perp)
\end{gather}
\end{subequations}
