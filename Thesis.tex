...
\input{Coordinate_Systems} % file "Thesis_Appendix_A.tex"
\cleardoublepage

% re-set arabic numbering (B.1,B.2,...) (optional, use only if chapter prefix is added)
%\setcounter{page}{1}

%\input{Bjorken_Coordinates} % file "Thesis_Appendix_B.tex"
%\cleardoublepage

%Atom mute bem vindes a minhe tese sobre \gls{xml} oque descute entre outres cosems  \gls{xml} e  \glspl{xml}
