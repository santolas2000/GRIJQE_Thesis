...
\end{split}
\end{equation}
The first and second lines are $0$ because of $\alpha^i_1$ and $\alpha^i_2$ being pure gauge fields. For the first line, taking $\alpha_1^i = (i/g) U^\dagger \partial^i U$:
\begin{equation}
\begin{split}
