...
It is easiest to start by considering the case of a single nucleus, chosen to be Nucleus 1, moving in the positive $x^1$ direction. \textcolor{red}{First done in \cite{}, also done in \cite{} (good reference)}. The Yang-Mills equations are solved in the light-cone gauge, where $A^+=0$, an axial gauge condition. \textcolor{blue}{(\citep{Kovner_1995}: "one has direct access to the gluon distribution functions of the parton model")}
