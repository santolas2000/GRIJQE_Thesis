...
\draw[->] (0.5,0) arc [start angle=0, end angle=150, radius=0.5] node[pos=0.5, above left] {$\theta_{y-w}$};
...
\draw[->] (-0.606,0.35) arc [start angle=150, end angle=225, radius=0.7] node[pos=0.5, left] {$\theta_l$};
